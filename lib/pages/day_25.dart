...
class Day25Widget extends StatefulWidget {
  const Day25Widget({
    super.key,
  });

  @override
  State<Day25Widget> createState() => _Day25WidgetState();
}

class _Day25WidgetState extends State<Day25Widget> {
  Day25Solution data = Day25Solution();
...
class _Day25Painter extends CustomPainter {
  Day25Solution data;
  _Day25Painter(this.data);
