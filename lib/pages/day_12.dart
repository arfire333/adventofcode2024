...
class Day12Widget extends StatefulWidget {
  const Day12Widget({
    super.key,
  });

  @override
  State<Day12Widget> createState() => _Day12WidgetState();
}

class _Day12WidgetState extends State<Day12Widget> {
  Day12Solution data = Day12Solution();
...
class _Day12Painter extends CustomPainter {
  Day12Solution data;
  _Day12Painter(this.data);
