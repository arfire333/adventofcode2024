...
class Day23Widget extends StatefulWidget {
  const Day23Widget({
    super.key,
  });

  @override
  State<Day23Widget> createState() => _Day23WidgetState();
}

class _Day23WidgetState extends State<Day23Widget> {
  Day23Solution data = Day23Solution();
...
class _Day23Painter extends CustomPainter {
  Day23Solution data;
  _Day23Painter(this.data);
