...
class Day21Widget extends StatefulWidget {
  const Day21Widget({
    super.key,
  });

  @override
  State<Day21Widget> createState() => _Day21WidgetState();
}

class _Day21WidgetState extends State<Day21Widget> {
  Day21Solution data = Day21Solution();
...
class _Day21Painter extends CustomPainter {
  Day21Solution data;
  _Day21Painter(this.data);
