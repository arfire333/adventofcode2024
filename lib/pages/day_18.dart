...
class Day18Widget extends StatefulWidget {
  const Day18Widget({
    super.key,
  });

  @override
  State<Day18Widget> createState() => _Day18WidgetState();
}

class _Day18WidgetState extends State<Day18Widget> {
  Day18Solution data = Day18Solution();
...
class _Day18Painter extends CustomPainter {
  Day18Solution data;
  _Day18Painter(this.data);
